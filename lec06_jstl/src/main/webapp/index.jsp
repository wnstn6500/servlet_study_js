...
<body>
	...
	<%
		Planet t = new Planet("지구",1.5,true);
		request.setAttribute("planet",t);

		 
	%>
	<p>이름 : ${planet.name}</p>
	<p>태양으로부터의 거리 : ${planet.distance}억 km</p>
	<p>거주 가능 여부 : ${planet.can ? "O" : "X"}</p>
	...
	<fmt:formatNumber value="0.875" pattern="00000.00"/><br>
	...
	<c:set var="data" value="Har Are You? I am fine"/>
	<p><c:out value="${data }"/></p>
	
	
	<form method="post" action="/selectStar">
	<input type="number" name="starCount">
